...
import static pro.deves.sunshineapp.data.WeatherContract.LocationEntry;
import static pro.deves.sunshineapp.data.WeatherContract.WeatherEntry;
...
public class TestProvider extends AndroidTestCase {
    ...
    static ContentValues[] createBulkInsertWeatherValues(long locationRowId) {
        ...
        for ( int i = 0; i < BULK_INSERT_RECORDS_TO_INSERT; i++, currentTestDate+= millisecondsInADay ) {
            ...
            weatherValues.put(WeatherContract.WeatherEntry.COLUMN_MAX_TEMPERATURE, 75 + i);
            weatherValues.put(WeatherContract.WeatherEntry.COLUMN_MIN_TEMPERATURE, 65 - i);
