...
public class TestDb extends AndroidTestCase {
    ...
    public void testCreateDb() throws Throwable {
        ...
        locationColumnHashSet.add(WeatherContract.LocationEntry.COLUMN_CITY);
    ...
    */
    ...
    public void testWeatherTable() {
        ...
        assertTrue("rowId was -1", rowId != -1);
        // Query the database and receive a Cursor back
        Cursor c = db.query(WeatherContract.WeatherEntry.TABLE_NAME,null,null,null,null,null,null);

        // Move the cursor to a valid database row
        assertTrue("no data was returned", c.moveToFirst());

        TestUtilities.validateCurrentRecord("testInsertReadDb weatherEntry failed to validate", c, contentValues);
    ...
    public long insertLocation() {
        ...
        // Insert ContentValues into database and get a row ID back
        long insertedRowId = db.insert(WeatherContract.LocationEntry.TABLE_NAME, null, contentValues);
        if (insertedRowId == -1){
            fail("row id was -1 !!");
        }
        // Query the database and receive a Cursor back
        ...
        while (cursor.moveToNext()){
            TestUtilities.validateCurrentRecord("an error has occurred", cursor, contentValues);
        }
