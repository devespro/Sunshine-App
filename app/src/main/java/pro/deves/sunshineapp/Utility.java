...
public class Utility {
    ...
    public static String formatTemperature(Context context,double temperature, boolean isFahrenheit){
        double temp;
        if (!isFahrenheit){
    ...
    public static String getFriendlyDayString(Context context, long dateInMillis){
        ...
        if (julianDay == currentJulianDay){
            ...
            SimpleDateFormat shortendDateFormat = new SimpleDateFormat("EEE dd.MM");
